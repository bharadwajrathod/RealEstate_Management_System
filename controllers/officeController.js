...
exports.postAddProperty = (req, res) => {
  ...
  const query = `insert into property (PID , ID , OWNER_NAME , OWNER_MOBILE ,  NO_OF_BEDROOMS , NO_OF_BATHROOMS , PRICE , STATUS , TAG  , LIST_DATE , AREA , CITY , pincode ) values
  ( '${PID}' , '${ID}' , '${OWNER_NAME}' , '${OWNER_MOBILE}' , '${NO_OF_BEDROOMS}' ,'${NO_OF_BATHROOMS}' ,'${PRICE}' , '${STATUS}' ,'${TAG}'  , 0 ,'${AREA}', '${CITY}', '${pincode}');`
